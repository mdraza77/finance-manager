...
@section('title', 'Record Transaction - Finance Admin')
    ...
    <main id="main" class="p-6 bg-gray-50 min-h-screen transition-all duration-300">
        ...
        @if ($errors->any())
            <div
                ...
                <div>
                    <span class="font-bold">Error!</span> <span class="text-sm font-medium">Transaction Unsuccessful.
                        Please check the form below.</span>
                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="category" id="category" required
                                        ...
                                        <option value="" disabled selected>Please select a type first</option>
                                    </select>
                                    @error('category')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="description" id="description" rows="3"
                                        ...
                                        placeholder="Add notes about this transaction...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
