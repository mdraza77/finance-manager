...
@section('title', 'Create User - Finance Admin')
    ...
    <main id="main" class="p-6 bg-gray-50 min-h-screen transition-all duration-300">
        ...
        @if ($errors->any())
            <div
                ...
                <div>
                    <span class="font-bold">Error!</span> <span class="text-sm font-medium">User Creation Unsuccessful.
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            {{-- Important: We keep the ID for Select2 to initialize correctly --}}
                            <select name="roles[]" id="role__" required
                                ...
                                @foreach ($roles as $id => $name)
                                    <option value="{{ $id }}"
                                        {{ is_array(old('roles')) && in_array($id, old('roles')) ? 'selected' : '' }}>
                                        {{ $name }}
                                    </option>
                                @endforeach
                            </select>
